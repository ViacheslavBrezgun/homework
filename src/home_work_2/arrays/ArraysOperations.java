...
//        System.out.println("\n" + sum);
    //  }
    public static int sumChetPOL(int[] arrays) {
...
//    }
    public static int maxChetIndx(int[] arr) {
        int sum = 0;
        int count = 0;
        for (int i = 1; i < arr.length; i++) {
            if (i % 2 == 0) {
...
//    }
    //2.4.3. Элементы массива, которые меньше среднего арифметического
    public static int[] smallerArithmeticAverages(int[] arr) {
        int sum = 0;
        int count = 0;
        for (int i = 0; i < arr.length; i++) {
            sum += arr[i];
...
//
//    }
    public static int[] MinMin(int[] arr) {
